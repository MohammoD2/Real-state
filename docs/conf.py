# -*- coding: utf-8 -*-
#
# Real state documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'Real statedoc'
...
latex_documents = [
    ('index',
     'Real state.tex',
     u'Real state Documentation',
     u"Mohammod Ibrahim Hossain", 'manual'),
]
...
man_pages = [
    ('index', 'Real state', u'Real state Documentation',
     [u"Mohammod Ibrahim Hossain"], 1)
]
